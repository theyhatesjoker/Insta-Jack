#####joker#####
print('THIS ENCODE BY JOKER | @JOKERPY • ')
...
joker = render('{meta}', colors=['white', 'blue'], align='center')
print(f'''\n  ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓   
                      {joker}
    ~ BY : @JokerPy | Channel: @Theyhates_joker ~
   ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛    
''')
token = input(f" 𝐓𝐨𝐤𝐞𝐧: ")
print("\x1b[1;39m—" * 60)
ID = input(" 𝐈𝐃: ")
dod = requests.get('https://pastebin.com/raw/Tte2ZpC0').text
ded = dod.splitlines()  

print("\x1b[1;39m—" * 60)
if ID not in ded:  
    print("\x1b[1;39m—" * 60)
    print('You Are Not Allowed To Use Tool, Contact @JokerPy • ')
...
BIO : ﴾ {biography} ﴿
RESET :  {reset_email}
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: @JokerPy @Theyhates_joker'''
        print(porno)
        with open('meta.txt', 'a') as ff:
            ff.write(f'{porno}\n')
...
def seks(email):
  ...
  try:
    ...
    if pp == '0':
      ...
      if 'email_is_taken' in str(response.text):joker(email)
      else:kotu_insta+=1
    elif pp == '1':
      ...
      if '"user":true' in response:joker(email)
      else:kotu_insta+=1
  except:''
  os.system('clear' if os.name == 'posix' else 'cls')
